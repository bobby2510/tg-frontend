        ...
        <React.Fragment>
            ...
            <div className='mini-container' style={{padding:0}}>
                <div className="section-info">
                    <span className='section-primary'>{getSportName(props.sportIndex)} Saved Matches</span>
                    <span className='section-secondary'>you can create teams and check results for saved matches</span>
