...
const Partision = (props)=>{
    ...
    return (
        ...
        <div className="section-info">
            <span className='section-primary'>Team Partision Section</span>
            <span className='section-secondary'>Teams will be created with selected no.f players from each team</span>
