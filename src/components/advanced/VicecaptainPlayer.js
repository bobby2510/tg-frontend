...
const VicecaptainPlayer = (props)=>{
    ...
    return (
        <React.Fragment>
            ...
            <div className="section-info">
                <span className='section-primary'>Vice Captain Player Section</span>
                <span className='section-secondary'>Selected Players will be considered for vice-captain</span>
