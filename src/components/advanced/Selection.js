...
const Selection = (props)=>{
    ...
    return (
        ...
        <div className="section-info">
            <span className='section-primary'>Player % Selection Strategy</span>
            <span className='section-secondary'>This is a new Observation found in fantasy  </span>
            <span className='section-secondary'> if have idea select <span style={{color:'black',fontWeight:500}}>1 or More</span></span>
